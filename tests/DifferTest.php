...
class DifferTest extends TestCase
{
    ...
    {
        $file1 = 'tests/fixtures/step3/file1.yml.json.json';
        $file2 = 'tests/fixtures/step3/file2.yml.json.json';
    ...
    {
        $file1 = 'tests/fixtures/step5/file1.yml.json.json';
        $file2 = 'tests/fixtures/step5/file2.yml.json.json';
        $diff = genDiff($file1, $file2, FM_STYLISH);
        $this->assertStringEqualsFile('tests/fixtures/step5/res.diff', $diff);
    }
